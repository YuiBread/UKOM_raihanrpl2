    ...
    <div class="container">
        ...
        <div class="ketname2">
            ...
            <div class="box">
                <label>Judul</label>
                <br>
                <input class="inbox" name="judul" type="text">
            </div>
            <div class="box">
                <label>Penulis</label>
                <br>
                <input name="penulis" class="inbox" type="text">
            </div>
            <div class="box">
                <label>Penerbit</label>
                <br>
                <input name="penerbit" class="inbox" type="text">
            </div>
            <div class="box">
                <label>Tahun Terbit</label>
                <br>
                <input name="tahunterbit" class="inbox" type="text">
            </div>
