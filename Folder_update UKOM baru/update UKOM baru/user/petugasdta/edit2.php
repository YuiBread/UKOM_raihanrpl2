...
<body>
    <div class="sidebar">
        ...
        <!-- <hr> -->
        <div class="side">
            <p><a href="petugas.php" class="sidea">Home</a></p>
...
// $ftbook = mysqli_query($connect, "SELECT * FROM buku WHERE foto = $id2");
$data = mysqli_fetch_assoc($book);
// $data2 = mysqli_fetch_assoc($ftbook);
?>
            ...
            <fieldset>
                ...
                <div class="newreport">
                    ...
                    <div class="box">
                        ...
                        <br>
                        <textarea class="inbox" required name="sinopsis">
                            <?= $data['sinopsis']; ?>
                        </textarea>
                    </div>
                    <br>
                    <input type="submit" class="button" name="update" value="update"> <!-- kirim nya jir -->
                </div>
